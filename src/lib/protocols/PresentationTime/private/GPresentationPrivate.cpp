...
void GPresentation::GPresentationPrivate::bind(wl_client *client, void *data, UInt32 version, UInt32 id)
{
    ...
    new GPresentation(client,
                        ...
                        &GPresentation::GPresentationPrivate::resource_destroy);
}

void GPresentation::GPresentationPrivate::resource_destroy(wl_resource *resource)
{
    GPresentation *gPresentation = (GPresentation*)wl_resource_get_user_data(resource);
    delete gPresentation;
}
