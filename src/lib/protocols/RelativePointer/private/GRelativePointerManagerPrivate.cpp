...
{
    GRelativePointerManager *gRelativePointerManager = (GRelativePointerManager*)wl_resource_get_user_data(resource);
    delete gRelativePointerManager;
}
...
void GRelativePointerManager::GRelativePointerManagerPrivate::get_relative_pointer(wl_client *client, wl_resource *resource, UInt32 id, wl_resource *pointer)
{
    ...
    if (rPointer->relativePointerResource())
        return;
