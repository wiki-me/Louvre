...
///@{
     ...
     */
    virtual LTouch *createTouchRequest(LTouch::Params *params);
...
///@{
     ...
     * This method is called during the compositor uninitialization.
     *
     * @param pointer The LPointer that will be destroyed.
     *
     * @par Default Implementation
     ...
     * This method is called during the compositor uninitialization.
     *
     * @param keyboard The LKeyboard instance that will be destroyed.
     *
     * @par Default Implementation
